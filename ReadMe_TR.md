...
- 🌐 Web arayüzü: responsive, kullanıcı dostu deneyim, cookie tabanlı dil kalıcılığı (TR/EN/FR/RU/UK/HI)
...
- ✅ Public arayüzde cookie tabanlı dil kalıcılığı (TR/EN/FR/RU/UK/HI)
