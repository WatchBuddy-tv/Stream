...
export async function initNextEpisode(meta, providerQueryAmp, apiBase) {
    ...
    try {
        ...
        // Sonraki bölüm linkine her zaman TEMİZ seri adı taşınır (data-content-base-title) —
        // görüntülenen data-content-title zaten "Seri ‖ S1 E2 - Bölüm Adı" şeklinde süslü,
        // onu taşırsak her sayfa geçişinde üstüne bir kat daha süs eklenir.
        const container  = document.getElementById('video-links-data');
        const rawTitle   = container?.dataset.contentBaseTitle || container?.dataset.contentTitle || '';
