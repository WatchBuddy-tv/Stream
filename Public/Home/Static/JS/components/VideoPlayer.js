...
import { detectFormat, parseRemoteUrl, createHlsConfig, suggestInitialMode, hasCustomHeaders, ProxyMode, buildProxyUrlWithMode, isIpPinnedUrl } from '../video-utils.min.js';
...
export default class VideoPlayer {
    ...
    loadVideo(index, isAutoSwitch = false) {
        ...
        // Proxy URL'i oluştur (Go/Python fallback destekli, IP-pinned ise direct HEAD)
        let proxyUrl = isIpPinnedUrl(originalUrl) ? originalUrl : this.buildProxyUrl(originalUrl, userAgent, referer, 'video', extraHeaders);
